export default function MusicAppPricing(){
    return<>
    <h1 className="mt-8 mb-12 text-center text-3xl md:text-5xl font-semibold text-gray-900">Choose your listening plan</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto gap-8 mt-16">
        <div className="bg-gray-100 ring-1 ring-gray-300 grid grid-rows-[1fr_auto] rounded-xl p-8 gap-6">
          <div className="grid grid-rows-[auto_auto_auto_1fr] gap-y-2">
            ...
            <p className="text-4xl font-bold text-gray-900">$0<span className="text-base font-medium text-gray-500">/month</span></p>
            <p>
              Start exploring millions of songs with basic features and ads.
            </p>
            <ul className="mt-6 space-y-2 text-sm text-gray-700">
              <li>
                <span aria-hidden className="text-green-700 mr-2">&#10003;</span>Ad-supported streaming
              </li>
              <li>
                <span aria-hidden className="text-green-700 mr-2">&#10003;</span>Curated playlists
              </li>
            </ul>
          </div>
          <a
        ...
        <div className="relative bg-gray-950 text-white ring-2 ring-fuchsia-500 p-8 grid grid-rows-[1fr_auto] gap-6 rounded-xl scale-105">
          <div className="absolute -top-3 right-3 bg-gradient-to-r from-fuchsia-500 to-indigo-500 rounded-full px-3 py-1 text-xs font-bold text-white">Most Popular</div>
          <div className="grid grid-rows-[auto_auto_auto_1fr] gap-y-2">
            ...
            <ul className="mt-6 space-y-2 text-sm text-fuchsia-100">
              <li>
                <span aria-hidden className="text-green-500 mr-2">&#10003;</span>Ad-free listening
              </li>
              <li>
                <span aria-hidden className="text-green-500 mr-2">&#10003;</span>Offline playback
              </li>
              <li>
                <span aria-hidden className="text-green-500 mr-2">&#10003;</span>Unlimited skips
              </li>
            </ul>
          </div>
          <a 
